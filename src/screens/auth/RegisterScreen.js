...
export default function RegisterScreen({ navigation }) {
    ...
    return <Screen scroll contentContainerStyle={sharedStyles.authContainer}>
        ...
        <Text style={sharedStyles.screenTitle}>Cria a tua conta</Text>
        <Text style={sharedStyles.screenSubtitle}>Introduz os teus dados de acesso.</Text>
        <View style={sharedStyles.form}>
            ...
            <Button title="Já tenho conta" variant="secondary" onPress={() => navigation.navigate(ROUTES.LOGIN)} />
        </View>
    </Screen>;
}
